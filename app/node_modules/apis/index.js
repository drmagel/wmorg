          ...
          pndID.forEach(function(pnd){
            pendants.get(pnd, {loanAppID:1, clctAppID:1}, function(e,p){
              ...
              applications.get(p.loanAppID, {pendants:1}, function(e,a){
                ...
                applications.update(r.loanAppID, a, function(e){
                  if(e){return res.status(500).json({error: "API:"+api+":applications.update: "+e})};                        
                });
              });
              applications.get(r.clctAppID, {pendants:1}, function(e,a){
                ...
                if(!!!a){return res.end()};
                a.pendants.splice(a.pendants.indexOf(pnd),1);
                applications.update(r.clctAppID, a, function(e){
                  if(e){return res.status(500).json({error: "API:"+api+":applications.update: "+e})};                        
                });
              });
        ...
        case 'create':
          ...
          pendants.get(pndID,{},function(e,p){
            ...
            var transaction = {
                  ...
                  ctclUserID: 0,
                  clctAppID: p.cltlAppID,
                  amount: p.amount,
                  status: 'active', // 'active', 'completed' or 'canceled'
                  messages: [], // [{from: '', text: '', creationDate: date}, {}],
                  creationDate: d.getTime(),
                  overdueDate: d.getTime(),
                  commitedDate: d.getTime()
                };
            applications.get(p.loanAppID,{},function(e,l){ // LOAN application
              if(e){return res.status(500).json({error: "API:"+api+":applications get: "+e})};
              
            });
            applications.get(p.cltlAppID,{},function(e,l){ // COLLECT application
              if(e){return res.status(500).json({error: "API:"+api+":applications get: "+e})};
