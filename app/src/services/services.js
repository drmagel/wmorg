...
wmoServices.factory('Logout', ['$resource', '$window',
  function($resource, $window){
    var sessID = $window.sessionStorage.getItem('sessID');
console.log('Logout:Service:sessID ' + sessID);
    return $resource($REST, {}, {
      get: {method:'POST', params:{api:'logout'}, headers:{'Auth': sessID}},
    });
  }]);
...
//wmoServices.factory('ValidateByPassword', ['$resource', '$window', '$location', '$uibModal',
//  function($resource, $window, $location, $uibModal){
...
/*
wmoServices.factory('processMngr', ['$routeParams',
